            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="inline-block mb-6">
                  <span className="text-sm tracking-[0.2em] uppercase text-amber-400/70 font-medium">Юридические услуги</span>
                </div>
                ...
                <p className="text-xl text-[#d9ccb8] font-medium leading-relaxed">
                  Защитим ваши интересы и обеспечим правовую безопасность вашего бизнеса.
                  Наши юристы имеют обширный опыт работы в различных отраслях права.
                </p>
              </motion.div>
            </div>
          </div>
